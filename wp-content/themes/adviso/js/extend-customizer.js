/**
 *
 *	JS for extending the Customizer to accomodate Nested Panels and Sections
 *
...
( function( $ ) {
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'adviso_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'adviso_panel' !== panel.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      ...
      if (
        'adviso_section' !== this.params.type ||
