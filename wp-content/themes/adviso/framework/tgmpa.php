...
add_action( 'tgmpa_register', 'adviso_register_required_plugins' );
 ...
 */
function adviso_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'adviso',                 // Unique ID for hashing notices for multiple instances of TGMPA.
